...
const ItemListLayer = () => {
    ...
    useEffect(() => {
        ...
        setCurrentPage(1);
    }, [searchTerm, allItems, sortField, sortDirection, selectedCategory, selectedSubcategory, selectedItemType]);
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-4">
                            <div className="card border">
                                <div className="card-body">
                                    <h6 className="text-md text-secondary-light mb-16">No Items Exist</h6>
                                    <button
                                        type="button"
                        ...
                        <>
                            <div className="table-responsive">
                                <table className="table bordered-table mb-0">
                                    <thead>
                                        <tr>
                                            <th scope="col" style={{ width: '120px' }}>Item Code</th>
                                            <th
                                                scope="col"
                                            ...
                                            <th scope="col" style={{ width: '120px' }}>Subcategory</th>
                                            <th scope="col" style={{ width: '120px' }}>Item Type</th>
